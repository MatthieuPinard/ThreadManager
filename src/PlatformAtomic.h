...
// uInt and sInt have the same size, the size of size_t.
		...
		#define ALIGNED __declspec(align(4)) // Intel 8.1.1: 32-bits RW on 32-bits aligned memory are atomic.
	#elif defined(_M_AMD64)
		typedef long long sInt;
		typedef unsigned long long uInt;
		#define ALIGNED __declspec(align(8)) // Intel 8.1.1: 64-bits RW on 64-bits aligned memory are atomic.
	#endif
	typedef sInt _sInt;
